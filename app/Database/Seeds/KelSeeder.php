...
class KelSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            [
                'id_kec'   => '14',
                'kelurahan'   => 'Tanggulung Barat'
            ],
            [
                'id_kec'   => '14',
                'kelurahan'   => 'Tanggulung Timur'
            ],
            [
                'id_kec'   => '15',
                'kelurahan'   => 'Cimanglid'
