...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tambah Infrastruktur Produksi</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container">
      <form class="form-horizontal" action="/infrastruktur/save" method="post">
        <?= csrf_field() ?>
        <div class="row">
          <div class="col-sm-12">
        ...
        <div class="row">
          <div class="col-12 text-center">
            ...
            <input type="submit" value="Tambah Infrastruktur" class="btn bg-gradient-primary">
          </div>
        </div>
      </form>
    </div>
