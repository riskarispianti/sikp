...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tambah Data Pangan</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3">
                    <h1 class="card-title">Data Tanaman Pangan</h1>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-two-produksi-tab" data-toggle="pill" href="#custom-tabs-two-produksi" role="tab" aria-selected="true">Produksi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-ancaman-tab" data-toggle="pill" href="#custom-tabs-two-ancaman" role="tab" aria-selected="false">Ancaman</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-tempat-tab" data-toggle="pill" href="#custom-tabs-two-tempat" role="tab" aria-selected="false">Tempat Produksi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-sentra-tab" data-toggle="pill" href="#custom-tabs-two-sentra" role="tab" aria-selected="false">Sentra produksi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-infrastruktur-tab" data-toggle="pill" href="#custom-tabs-two-infrastruktur" role="tab" aria-selected="false">Infrastruktur produksi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-produsen-tab" data-toggle="pill" href="#custom-tabs-two-produsen" role="tab" aria-selected="false">Produsen</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-two-produksi" role="tabpanel" aria-labelledby="custom-tabs-two-produksi-tab">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-two-ancaman" role="tabpanel" aria-labelledby="custom-tabs-two-ancaman-tab">
                    <div class="card-body text-muted">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-two-sentra" role="tabpanel" aria-labelledby="custom-tabs-two-sentra-tab">
                    <div class="card-body text-muted">
