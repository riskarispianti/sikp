      ...
      <form class="form-horizontal" action="/tanaman/save" method="post">
            ...
            <div class="card card-tabs card-info">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3">
                    <h3 class="card-title">Tambah Tanaman Pangan</h3>
                  </li>
                  <li class="nav-item">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-two-infrastruktur" role="tabpanel" aria-labelledby="custom-tabs-two-infrastruktur-tab">
                    <div class="card-body text-muted">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="pengel_jar_irigasi" id="pengel_jar_irigasi" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="" class="col-sm-5 col-form-label">Infrastruktur Pengelolaan Irigasi</label>
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="infras_pengel_air" id="infras_pengel_air" disabled>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="row">
          <div class="col-12 text-center">
            ...
            <input type="submit" value="Tambah Data Pangan" class="btn bg-gradient-info">
          </div>
        </div>
      </form>
    </div>
