...
class Peternakan extends BaseController
{
    ...
    public function edit_detail($id_ternak)
    {
        $data = [
            'title' => 'Edit Data Peternakan',
            'validation' => \Config\Services::validation(),
        ...
        return view('peternakan/edit_detail', $data);
    }

    public function edit_detail_home($id_ternak)
    {
        $data = [
            'title' => 'Edit Data Peternakan',
            'validation' => \Config\Services::validation(),
        ...
        return view('peternakan/edit_detail_home', $data);
    }
    ...
    public function update_detail($id_ternak)
    {
        // validasi input
        if (!$this->validate([
            'jenis_ternak' => [
        ...
        return redirect()->to('/peternakan/detail/' . $id_ternak);
    }
    public function update_detail_home($id_ternak)
    {
        // validasi input
        if (!$this->validate([
            'jenis_ternak' => [
        ...
        return redirect()->to('/peternakan/detail_home/' . $id_ternak);
    }
